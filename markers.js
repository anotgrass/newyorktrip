const locations = {
    ...
    "Thursday, December 12": [
        { name: "Rockefeller Center", coords: [-73.979858, 40.759245], color: "green" },
        { name: "Rockefeller Christmas Tree", coords: [-73.9787, 40.7587], color: "green" },
        { name: "Rockefeller Skating Rink", coords: [-73.978409, 40.758607], color: "green" },
    ...
    "Sunday, December 15": [
        { name: "Chelsea Market", coords: [-74.0061, 40.7425], color: "orange" },
        { name: "The High Line", coords: [-74.0049, 40.7479], color: "orange" },
        { name: "Hudson Yards", coords: [-74.0017, 40.7546], color: "orange" },
        { name: "The Edge Observatory", coords: [-74.0011, 40.7535], color: "orange" }
    ],

    "Monday, December 16": [
        { name: "LGA Airport", coords: [-73.8726, 40.7769], color: "yellow" }
    ]
};